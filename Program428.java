...
class DBMS
{
    ...
    {
        System.out.println("Information of student in the table is : "+str);
...
5 : select *      (Marks) from student
6 : select *      (Marks) from student
7 : select *      (Marks) from student
8 : select *      (Marks )from student
